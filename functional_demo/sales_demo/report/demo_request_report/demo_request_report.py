...
def execute(filters=None):
	...
	columns = [
		...
		{"label": _("Sales Person (Lead)"), "fieldname": "lead", "fieldtype": "Link", "options": "Lead", "width": 130},
		{"label": _("Sales Person (User)"), "fieldname": "sales_person", "fieldtype": "Link", "options": "User", "width": 130},
